...
#define STM32_FLASH_SIZE        0x080000        /* STM32 FLASH ×Ü´óÐ¡ */
#define FLASH_WAITETIME         50000           /* FLASHµÈ´ý³¬Ê±Ê±¼ä */

/**************************************************************************************/
/* G474Ð¾Æ¬µÄ512KFLASHÈÝÁ¿µÄÒ³µØÖ··Ö²¼ÈçÏÂ£¬¹²ÓÐÁ½¸öBANK£¬Ã¿¸öBANKÓÐ128Ò³£¬Ã¿Ò»Ò³2kb´óÐ¡ */
...
void stmflash_write(uint32_t WriteAddr, uint32_t *pBuffer, uint32_t NumToWrite);    /* ´ÓÖ¸¶¨µØÖ·¿ªÊ¼Ð´ÈëÖ¸¶¨³¤¶ÈµÄÊý¾Ý */
void stmflash_read(uint32_t ReadAddr, uint32_t *pBuffer, uint32_t NumToRead);       /* ´ÓÖ¸¶¨µØÖ·¿ªÊ¼¶Á³öÖ¸¶¨³¤¶ÈµÄÊý¾Ý */
